...
/**
 * The anchored upstream core version, derived from upstream/aalc tag or fallback.
 */
internal fun Project.aalcUpstreamVersion(): String {
    val aalcDir = rootProject.file("upstream/aalc")
    if (aalcDir.isDirectory) {
        val tag = runCatching {
            providers.exec {
                workingDir(aalcDir)
